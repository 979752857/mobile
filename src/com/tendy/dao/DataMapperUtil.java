...
public class DataMapperUtil {
    ...
    public static List<UserAccountPhone> selectUserAccountPhoneByPhoneAndBusiness(String phone, Integer businessId, Integer iDisplayStart,
                                                                                  Integer iDisplayLength, String status, String tag, String notPhone, Integer openBusinessId, String position, String type){
        return userAccountPhoneMapper.selectListByPhone(phone, businessId, iDisplayStart, iDisplayLength, status, tag, notPhone, openBusinessId, position, type);
    }
    ...
    public static int countUserAccountPhoneByPhoneAndCity(String phone, Integer businessId, String status, String tag, String notPhone, Integer openBusinessId, String position, String type){
        return userAccountPhoneMapper.countListByPhone(phone, businessId, status, tag, notPhone, openBusinessId, position, type);
    }
